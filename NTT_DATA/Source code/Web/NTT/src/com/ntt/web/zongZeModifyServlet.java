...
public class zongZeModifyServlet extends HttpServlet {
...
////		} else 
		...
		try {
			con = dbUtil.getCon();
			List<AppliBonus2> appliBonusList3 = appliBonusDao2.appliBonusList3(con, pageBean, appliBonus2, projectId);
			...
			request.setAttribute("appliBonusList3", appliBonusList3);
			request.setAttribute("mainPage", "charger/zongZeModify.jsp");
...
//	}
	...
	private String genPagation(int totalNum, int currentPage, int pageSize) {
		...
		pageCode.append("<a href='zongZeModify?page=1'>首页</a>");
		if (currentPage == 1) {
			pageCode.append("<class='disabled'><a href='#'>上一页</a>");
		} else {
			pageCode.append("<a href='zongZeModify?page=" + (currentPage - 1) + "'>上一页</a>");
		}
		for (int i = currentPage - 2; i <= currentPage + 2; i++) {
			...
			if (i == currentPage) {
				...
				pageCode.append("<a href='zongZeModify?page=" + i + "'>" + i + "</a>");
			}
		}
		if (currentPage == totalPage) {
			pageCode.append("<class='disabled'><a href='#'>下一页</a>");
		} else {
			pageCode.append("<a href='zongZeModify?page=" + (currentPage + 1) + "'>下一页</a>");
		}
		pageCode.append("<a href='zongZeModify?page=" + totalPage + "'>尾页</a>");
