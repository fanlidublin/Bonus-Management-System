...
public class LxServlet extends HttpServlet {
	...
	private String genPagation(int totalNum, int currentPage, int pageSize) {
		...
		pageCode.append("<li><a href='lxXize?page=1'>首页</a></li>");
		if (currentPage == 1) {
			pageCode.append("<li class='disabled'><a href='#'>上一页</a></li>");
		} else {
			pageCode.append("<li><a href='lxXize?page=" + (currentPage - 1) + "'>上一页</a></li>");
		}
		...
		if (currentPage == totalPage) {
			...
			pageCode.append("<li><a href='lxXize?page=" + (currentPage + 1) + "'>下一页</a></li>");
		}
		pageCode.append("<li><a href='lxXize?page=" + totalPage + "'>尾页</a></li>");
