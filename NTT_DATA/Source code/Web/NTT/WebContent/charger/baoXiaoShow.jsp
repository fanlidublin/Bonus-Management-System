		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav" >
					...
					<li><a href="?action=list"><i class="icon-chevron-right" ></i><font size="4" face="Microsoft YaHei">项目奖金额度划分</font></a></li>
				...
				<div class="span8">
					<jsp:include page="${mainPage==null?'blank_4.jsp':mainPage}"></jsp:include>
				</div>
		</div>	
	</div>
