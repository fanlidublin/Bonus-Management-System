		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav" >
					...
					<li><a href="zongZe?action=list"><i class="icon-chevron-right" ></i><font size="4" face="Microsoft YaHei">项目限制设定（总则）</font></a></li>
					<li><a href="bonusNorm?action=list"><i class="icon-chevron-right" ></i><font size="4" face="Microsoft YaHei">奖金标准设定</font></a></li>					
					<li>
						<a href="#show" data-toggle="collapse">
							<i class="icon-chevron-right"></i><font size="4" face="Microsoft YaHei">奖金分配比例规则<br>（细则）</font>
						</a>
						   	
						<ul id="show" class="nav nav-list collapse secondmenu" style="height: 0px;">
                        	<li><a href="zsXize"><i class="icon-chevron-right"></i><font size="3" face="Microsoft YaHei">正式社员部分</font></a></li>
                        	<li><a href="lxXize"><i class="icon-chevron-right"></i><font size="3" face="Microsoft YaHei">连携部分</font></a></li>
                        	<li><a href="bpXize"><i class="icon-chevron-right"></i><font size="3" face="Microsoft YaHei">BP社员部分</font></a></li>
                        	<li><a href="tzXize"><i class="icon-chevron-right"></i><font size="3" face="Microsoft YaHei">申请时已退职社员部分</font></a></li>
                        </ul>
					</li>					
	...
	<div id="footer" >
		<div id="round" style="height: 100px;background-image: url('images/top5.jpg')">
			<div align="center" style="float: center; padding-top:50px; padding-left:30px;" >
				<font color="white" size="4" ><b>© PTFC 团队</b></font>
			</div>
		</div>
	</div>
</body>
